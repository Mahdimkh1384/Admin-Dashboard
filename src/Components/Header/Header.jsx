            ...
            {isMobile ? (
                <div className="mobile-header">
                    <div className="mobile-top-section">
                        <button className="mobile-header-left-icon menuBtn" onClick={() => setIsShowMenuForPhone(p => !p)}>
                            <IoMenu />
                        </button>

                        <div className='mobile-admin-profile'>
                            {isShowMenuForPhone && <SideBar mobile onClose={() => setIsShowMenuForPhone(false)} />}
                        ...
                        <div className="mobile-control-btn">
                            <div className="notification-logo-box">
                                <button className='mobile-header-left-icon' onClick={() => setIsShowDetailModal(true)}>
                                    <AiOutlineBell />
                                </button>
                                <span className="mobile-notification-count">0</span>
                            </div>
                            <button className="mobile-header-left-icon mobile-theme-btn" onClick={changeTheme} title={isDark ? "حالت روشن" : "حالت تاریک"}>
                    ...
                    <div className="mobile-search-box-container">
                        ...
                        <div className={isShowSearchResult ? "mobile-search-result-box mobile-show" : "mobile-search-result-box"}>
                            <div className="mobile-search-result-box-header">
                                <h3>نتیجه جستجو</h3>
                            ...
                            {searchedData.map(product => (
                                <div className="mobile-search-result-box-product" key={product.id}>
